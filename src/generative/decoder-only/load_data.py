...
def load_wiki_data(train_split: float = 0.7, val_split: float = 0.15, test_split: float = 0.15, deterministic: bool = False):
    ...
    dataset_nl = dataset_nl.shuffle(seed=seed)  # Shuffle the dataset for randomness
    dataset_en = dataset_en.shuffle(seed=seed)  # Shuffle the dataset for randomness
